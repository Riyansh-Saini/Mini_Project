...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Predictor using Machine Learning", fg="green", bg="black")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
# w2 = Label(root, justify=LEFT, text="A Project by ", fg="white", bg="blue")
...
# def show_best_prediction():
#     # Get predictions and accuracies from each method
#     decision_tree_prediction, decision_tree_accuracy = DecisionTree()
#     random_forest_prediction, random_forest_accuracy = randomforest()
#     naive_bayes_prediction, naive_bayes_accuracy = NaiveBayes()
#
#     # Choose the method with the highest accuracy
#     best_accuracy = max(decision_tree_accuracy, random_forest_accuracy, naive_bayes_accuracy)
#     if best_accuracy == decision_tree_accuracy:
#         prediction = decision_tree_prediction
#     elif best_accuracy == random_forest_accuracy:
#         prediction = random_forest_prediction
#     else:
#         prediction = naive_bayes_prediction
#
#     t1.delete("1.0", END)
#     t1.insert(END, prediction)
...
dst = Button(root, text="Show Best Prediction", command=show_best_prediction, bg="green", fg="yellow")
